...
/***/ function(module, exports, __webpack_require__) {
	...
	var basscss = __webpack_require__(162);

	var Canvas = __webpack_require__(166);
	var ToolBar = __webpack_require__(171);
	...
	var ToolBar = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('div', { className: 'p4 flex flex-column border', __source: {
	      ...
	      className: classnames("mt2", "btn", "btn-primary", "black", { "bg-silver": this.state.currentTool != "paintbrush",
